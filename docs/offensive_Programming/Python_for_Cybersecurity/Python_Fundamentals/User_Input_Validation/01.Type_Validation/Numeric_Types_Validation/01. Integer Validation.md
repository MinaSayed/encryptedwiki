...
**4. Validate that the user enters an integer within a specific range**

This validation ensures the input is an integer and lies between a minimum and maximum value.

**Checks usually include:**

* Convert the input to `int()`
* Verify that `min_value <= int(input) <= max_value`

**Application of this check:**

Used for port numbers (0–65535), percentages (0–100), menu choices, or any bounded numeric input.

---

**5. Validate that the user enters a non-zero integer**
...
**6. Validate that the user enters an even or odd integer**
...
**7. Validate that the user enters an integer divisible by a step (modular integer)**
...
**8. Validate that the user enters a strictly formatted integer (no extra characters)**
...
**9. Validate that the user enters a custom domain integer**
